...
void Drawing::DrawSprite(LPD3DXSPRITE SpriteInterface, LPDIRECT3DTEXTURE9 TextureInterface, int PosX, int PosY, int Rotation, int Align, int Alpha)
{
	...
	SpriteInterface->Draw(TextureInterface, NULL, NULL, &Vec, D3DCOLOR_RGBA(0xFF, 0xFF, 0xFF, Alpha));
	SpriteInterface->End();
}
